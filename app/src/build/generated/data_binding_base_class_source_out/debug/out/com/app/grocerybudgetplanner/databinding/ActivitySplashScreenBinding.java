...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull LinearLayout rootView, @NonNull TextView appName,
      @NonNull ImageView logoImage, @NonNull LinearLayout main) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashScreenBinding((LinearLayout) rootView, appName, logoImage, main);
    }
